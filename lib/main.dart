  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        colorScheme: ColorScheme.fromSeed(seedColor: const Color(0xFF4FD1C5)), // Using highlight color as seed color
      ),
      initialRoute: '/',
      routes: {
        ...
        '/team-view': (context) => const TeamViewPage(),
        '/remarks': (context) => const RemarksPage(),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
      ), // Don't add drawer to splash screen since it redirects to login
      body: Center(
        child: Column(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color(0xFF4FD1C5), // Using highlight color
